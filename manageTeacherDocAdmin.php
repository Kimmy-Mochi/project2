...
<?php
        ...
        if($con->connect()){
            ...
            $sql="SELECT * from userprofile where status='T' LIMIT $start,$row1";
...
<html lang="en">
    ...
    <body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
        ...
        <div id="services" class="container-fluid text-center">
            ...
            <!-- search -->
            <div class="container">
                <h2 style="color: #1f3c88;">รายชื่ออาจารย์</h2><br>
                ...
                <form action="manageTeacherDocAdmin.php" class="search search-form ">
            ...
            <div class="container">
                ...
                <div class="row justify-content-end">
                        ...
                        <tbody align="left">
                            <tr>
                                ...
                                while($row= mysqli_fetch_array($objquerry)) {
                                    ...
                                    echo"<tr><td>".$i++."</td><td><a href=ShowDocSendTeacherAdmin.php?id=".$row['userProID'].">".$row['username']."</td>"
                    ...
                    <ul class="pagination">
                        ...
                        <a class="page-link" href="manageTeacherDocAdmin.php?page=<?=$page-1?>">Previous</a>
                        </li>

                        <?php for($i=1;$i<=$total_page;$i++) {?>
                        <li <?php if($page == 1) echo 'class="action"';?>>
                        <a class="page-link" href="manageTeacherDocAdmin.php?page=<?=$i?>"><?=$i ?></a></li>
                        
                        <?php } ?>

                        <li <?php if($page==$total_page ) echo 'class=""';?>>
                        <a class="page-link" href="manageTeacherDocAdmin.php?page=<?=$page+1?>">Next</a></li>
                    </ul>
                    </nav><br>
                    <!-- <div class="row">
