...
?>
 ...
 define('LINE_API',"https://notify-api.line.me/api/notify");
        ...
        $email = $_GET['id'];  
      $query = mysqli_query($link, "SELECT * FROM  userprofile  WHERE email  ='$email' ") or die(mysqli_error());
        ...
        if(!$mail->Send()){
                ...
                if($fetch["status"] == 'S'){
                  ...
                  echo "<script type='text/javascript'>alert('$message');window.location='HadminStaffappeal.php'</script>";}
                      ...
                      $message = "บันทึกสำเร็จ";
                  echo "<script type='text/javascript'>alert('$message');window.location='HadminStaffappeal1.php'</script>";
                  }
        }
