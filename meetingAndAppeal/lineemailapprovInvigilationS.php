...
//       echo $token;
      ...
      $mailMsg = "มีการร้องเรียนจากนิสิต";
      require 'PHPMailer/PHPMailerAutoload.php';
        ...
        if(!$mail->Send()){
                ...
                echo "<script type='text/javascript'>alert('$message');window.location='Hstudentappeal.php'</script>";
        }
        else{
                // echo "<script>alert('บันทึกสำเร็จ')</script>";
                // echo "<script>window.location='Hstudentappeal.php'</script>"; 
                $message = "บันทึกสำเร็จ";
                echo "<script type='text/javascript'>alert('$message');window.location='Hstudentappeal.php'</script>";
        }
  
      $str = "มีการร้องเรียนจากนิสิต"; 
