...
$connect = new mysqli('localhost', 'root', 'abc123', 'project2');
    ...
    INNER JOIN advisory  ON  students.SuserProID = advisory.SuserProID INNER JOIN teachers  ON  advisory.TuserProID= teachers.TuserProID
     WHERE MuserProID = $_SESSION[userProID] and advisoryStatus = 'M'")or die(mysqli_error($connect));
    $result = $connect->query($sql);
    
    // $sql1 =( "SELECT * FROM  meettingapprove  INNER JOIN mettingapproveteachers  ON  meettingapprove.meetID = mettingapproveteachers.meettingapproveID  
    // WHERE MuserProID = $_SESSION[userProID]")or die(mysqli_error());
        ...
        <div id="services" class="container-fluid text-center">
            ...
            <div class="container">
                ...
                <div class="row justify-content-end">
                    <form action="insertapprovestudent.php" method="POST">
                                ...
                                // $row1 = $result1->fetch_assoc();
                                 ...
                                 ?>  
                                       ...
                                       <td><?php echo $fetch['firstNameTH']."&nbsp;".$fetch['lastNameTH'];?></td>                               
                                        ...
                                        <td><a href="updateapprovestudent.php?id=<?php echo $row['meetID']; ?>"  style="background-color:#f7dd08" class="btn btn-info btn-lg">
                                        Edit
                                    </a></td> 
