...
//   $connect = new mysqli('localhost', 'id16923734_root', 'c6RVG|6-^J|}qR#+', 'id16923734_project2');
    ...
    WHERE students.SuserProID = $_SESSION[userProID] and advisoryStatus = 'M' ")or die(mysqli_error($connect));
                    ...
                    <table class="table table-striped" id="example" align="center">
                        ...
                        <tbody align="left">
                            <tr>
                                ...
                                $fetch = mysqli_fetch_array($query);
                                $query1 = mysqli_query($conn->connect(), "SELECT * FROM  `userprofile` WHERE `userProID`='$row[SuserProID]'") or die(mysqli_error($conn->connect()));
                        ...
                        <div class="col-sm-12 col-md-4 col-lg-12">
                            <div class="form-group">
                                <center>
                                    ...
                                    <a href="INstudentappeal.php" class="btn btn-info btn-lg">
