            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    ...
                    <li>
                        ...
                        <li>
                            <a href="../homeTeachers.php?#document">จัดเก็บเอกสาร</a>
                        </li>
                        <li>
                            <a href="../homeTeachers.php?#meeting">รายละเอียดการประชุม</a>
                        </li>
                        <li>
                            <a href="../homeTeachers.php?#appeal">การร้องเรียน</a>
                        </li>
                        <!-- <li>
                            <a href="../homeAdminStaff.php?#data">จัดการข้อมูลผู้ใช้ระบบ</a>
                        </li> -->
                        <li>
                            <a href="../homeTeachers.php?#contact">ติดต่อ</a>
                        </li>
                        <li>
                        <?php
