...
<?php
        ...
        if($con->connect()){
            ...
            $sql= "SELECT * from document INNER JOIN documenttype on document.typeID = documenttype.categoryID WHERE TuserProID = '$id' ORDER BY TuserproID LIMIT $start,$row1";
...
<html lang="en">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        ...
        <div id="services" class="container-fluid text-center">
            ...
            <!-- search -->
            <div class="container">
                <h2 style="color: #1f3c88;">ข้อมูลเอกสารของอาจารย์</h2><br>
                <!-- <form action="searchDocSTD.php" class="search search-form " method="GET">
                    <input type="search" placeholder="search" class="search-input" name="search">
                    <a href="searchDocSTD.php">
            ...
            <div class="container">
                ...
                <div class="row justify-content-end">
                    ...
                    <table class="table table-striped" id="myTable" align="center">
                        ...
                        <tbody align="left">
                            ...
                            while($row= mysqli_fetch_array($objquerry)) {
                                ...
                                echo"<tr><td>".$i++."</td><td>".$row['name_category']."</td><td>".$row['details']."</td>"
                            . "<td>".$row['uploadDatetime']."</td><td><a href=documentTeacher/".$row['fileName'].">".$row['fileName']."</a></td></tr>";
                            }
                            ?>
                            </tr>
                        </tbody>
                    ...
                    <ul class="pagination">
                        ...
                        <a class="page-link" href="ShowDocSendTercherAdmin.php?page=<?=$page-1?>">Previous</a>
                        </li>

                        <?php for($i=1;$i<=$total_page;$i++) {?>
                        <li <?php if($page == 1) echo 'class="action"';?>>
                        <a class="page-link" href="ShowDocSendTercherAdmin.php?page=<?=$i?>"><?=$i ?></a></li>
                        
                        <?php } ?>

                        <li <?php if($page==$total_page ) echo 'class=""';?>>
                        <a class="page-link" href="ShowDocSendTercherAdmin.php?page=<?=$page+1?>">Next</a></li>
                    </ul>
                    </nav><br>
                    <!-- <div class="row">
