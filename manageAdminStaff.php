...
<?php
        ...
        if($con->connect()){
            ...
            $sql="SELECT * from userprofile where status = 'A' OR status = 'SF' LIMIT $start,$row1 " ;
...
<html lang="en">
    ...
    <body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
        ...
        <div class="profile-images-card1">
            <!-- search -->
            <div class="container">
                <h2 style="color: #1f3c88;">จัดการข้อมูลผู้ดูแลระบบและเจ้าหน้าที่</h2><br>
            ...
            <div class="container">
                ...
                <div class="row justify-content-end">
                    <form action="checkEventAdminStaff.php" method="POST">
                        ...
                        <tbody align="left">
                            <tr>
                                <?php
                                    ...
                                    while($row= $objquerry->fetch_assoc()) {
                                        if($row['status'] == "A"){
                                            $status = "ผู้ดูแลระบบ";
                                            }
                                        elseif($row['status'] == "SF"){
                                            $status = "เจ้าหน้าที่";
                                        }
                                        else{
                                            echo "can't";
                                        ...
                                        . "<td><a href=editAdminStaff.php?id=".$row['userProID']." class='btn btn-warning a-btn-slide-text'>
                                        <span class='glyphicon glyphicon-edit' aria-hidden='true'></span>
                                        <span><strong>Edit</strong></span></a></td><td><a href=ShowDataAdmin.php?id=".$row['userProID'].">".$row['username']."</td>"
                                    . "<td>".$row['firstNameTH']."</td><td>".$row['lastNameTH']."</td><td>".$status."</td></tr>";
                    ...
                    <ul class="pagination">
                        ...
                        <a class="page-link" href="manageAdminStaff.php?page=<?=$page-1?>">Previous</a>
                        </li>

                        <?php for($i=1;$i<=$total_page;$i++) {?>
                        <li <?php if($page == 1) echo 'class="action"';?>>
                        <a class="page-link" href="manageAdminStaff.php?page=<?=$i?>"><?=$i ?></a></li>
                        
                        <?php } ?>

                        <li <?php if($page==$total_page ) echo 'class=""';?>>
                        <a class="page-link" href="manageAdminStaff.php?page=<?=$page+1?>">Next</a></li>
                    </ul>
                    </nav><br>
                        ...
                        <div class="col-sm-12 col-md-4 col-lg-12">
                            <div class="form-group">
                                <center>
                                    ...
                                    <a href="insertAdminStaff.php" class="btn btn-info btn-lg">
