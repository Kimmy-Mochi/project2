...
if($search != NULL){
    ...
    if($con->connect()){
        ...
        $sql= "SELECT * from document INNER JOIN documenttype on document.typeID = documenttype.categoryID WHERE SumuserProID = $_SESSION[userProID] AND name_category LIKE '%$search%'  ";
