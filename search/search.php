...
if($search != NULL){
    $con = new connectDB();
    if($con->connect()){
        $sql="SELECT userProID,firstNameTH,lastNameTH from userprofile where userProID LIKE '%$search%' or userProID LIKE '%$search' or userProID LIKE '$search%' 
        or firstNameTH LIKE '%$search%'  or firstNameTH LIKE '%$search'  or firstNameTH LIKE '$search%' 
        or lastNameTH LIKE '%$search%' or lastNameTH LIKE '%$search' or lastNameTH LIKE '$search%' AND status = 'S'" ;
                    ...
                    <tbody align="left">
                        <tr>
                            ...
                            while($row= mysqli_fetch_array($objquerry)) {
                                echo "<tr><td><a href=ShowDataStudent.php?id=".$row['userProID'].">".$row['userProID'], "</td><td><a href=ShowDataStudent.php?id=".$row['userProID'].">".$row['firstNameTH'],"</td><td>".$row['lastNameTH'],"</td></tr>";
                            }
      ?>
                        </tr>
                    </tbody>
