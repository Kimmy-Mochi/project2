...
if($search != NULL){
    ...
    if($con->connect()){
        ...
        $sql= "SELECT * from document INNER JOIN documenttype on document.typeID = documenttype.categoryID WHERE SumuserProID = '$id' AND name_category LIKE '%$search%'  ";
        ...
        <div id="services" class="container-fluid text-center">
            ...
            <div class="container">
                ...
                <div class="row justify-content-end">
                    <form action="checkEventTeacherDoc.php" method="POST">
                        ...
                        <div class="col-sm-12 col-md-4 col-lg-12">
                            <div class="form-group">
                                <center>
                                    ...
                                    <a href="teacherAddDoc.php" class="btn btn-info btn-lg">
