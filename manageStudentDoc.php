            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    ...
                    <li>
                        ...
                        <li>
                            <a href="homeTeachers.php">จัดการข้อมูลผู้ใช้ระบบ</a>
                        </li>
                        <li>
            ...
            <div class="container">
                ...
                <div class="row justify-content-end">
                        ...
                        <tbody align="left">
                            <tr>
                                ...
                                while($row= mysqli_fetch_array($objquerry)) {
                                    ...
                                    echo"<tr><td>".$i++."</td><td><a href=ShowDocSendStudent.php?id=".$row['SuserProID'].">".$row['SuserProID']."</td>"
                    ...
                    <ul class="pagination">
                        ...
                        <a class="page-link" href="manageStudentDoc.php?page=<?=$page-1?>">Previous</a>
                        </li>

                        <?php for($i=1;$i<=$total_page;$i++) {?>
                        <li <?php if($page == 1) echo 'class="action"';?>>
                        <a class="page-link" href="manageStudentDoc.php?page=<?=$i?>"><?=$i ?></a></li>
                        
                        <?php } ?>

                        <li <?php if($page==$total_page ) echo 'class=""';?>>
                        <a class="page-link" href="manageStudentDoc.php?page=<?=$page+1?>">Next</a></li>
                    </ul>
                    </nav><br>
                    <!-- <div class="row">
