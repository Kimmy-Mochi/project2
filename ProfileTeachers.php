...
<?php
        ...
        if($con->connect()){
            ...
            inner join academicposition on academicposition.acaposID = teachers.acaposID 
            inner join researchgroup on researchgroup.researchgrID = teachers.researchGroup
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    ...
                    <li>
                            <a href="homeTeachers.php" class="font">หน้าหลัก</a>
                        </li>
                        <li>
                            <a href="homeTeachers.php" class="font">จัดเก็บเอกสาร</a>
                        </li>
                        <li>
                            <a href="homeTeachers.php" class="font">รายละเอียดการประชุม</a>
                        </li>
                        <li>
                            <a href="homeTeachers.php" class="font">การร้องเรียน</a>
                        </li>
                        <li>
                            <a href="homeTeachers.php" class="font">ข้อมูลนักศึกษา</a>
                        </li>
                        <li>
                            <a href="homeTeachers.php" class="font">ติดต่อ</a>
                        </li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" style="background-color:darkblue">
                                <li><a href="ProfileTeachers.php" class="font">โปรไฟล์</a></li>
                                <li><a href="changePasswordTeacher.php" class="font">เปลี่ยนรหัสผ่าน</a></li>
           ...
           <div class="container-fluid">
                            ...
                            <div class="col-sm-6" align="left">
                                <div class="form-group " >
                                    <div>
                                        ...
                                        <?php
                                            echo "<input type='text' id='username' class='form-control font' size='20px' name='username' value='$row[1]'>";
                                            ?>
                                    </div>
                                </div>      
                            </div>
                    ...
                    <div class="col-sm-6" align="left">
                        <div class="form-group" >
                            <div>
                                ...
                                ?>
                                <select name="acaposition" id="acaposition" style="width: 100%;height:34px;text-align: left;" class="form-control font">
                                    <option id="acaposition" name="acaposition"  value="<?php echo $acaposID; ?>" style="font-size: 16px;" class="font"><?php echo $acaposNameTH; ?></option>
                                    <?php while ($row2 = $result2->fetch_row()) { ?>
                                        <option class="font" value="<?php echo ($row2[0]); ?>"><?php echo ($row2[1]); ?></option>
                                    <?php } ?>
                                </select>
                ...
                <div class="row">
                        ...
                        <div class="form-group" >
                            <div>
                                ...
                                <select name="researchgroup" id="researchgroup" style="width: 100%;height:34px;text-align: left;" class="form-control font">
                                    <option id="researchgroup" name="researchgroup" value="<?php echo $researchgrID ?>" class="font" style="font-size: 16px;"><?php echo $rechearchGr; ?></option>
                    ...
                    <div class="modal-footer">
                        ...
                        echo "<button class='btn btn-primary font'  type='submit' name='update' value='' onclick='myFunction()''>Save</button>";
        ?>
