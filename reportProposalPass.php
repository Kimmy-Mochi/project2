...
session_start();
 ...
 {  
      ...
      inner join documenttype on documenttype.categoryID = document.typeID where typeID=1 or typeID=2 or uploadDatetime BETWEEN '$d_s' AND '$d_e' ORDER BY SumuserProID ASC ";  
 ...
 {  
      ...
      $obj_pdf->SetTitle("ReportProposal");  
      ...
      $content = '';  
      $content .= '  
      <h1 align="center">รายงานสรุปข้อมูลของนักศึกษาที่ทำการสอบ Proposal ผ่าน</h1><br /><br />  
...
<div class="profile-images-card1">
    ...
    <div class="container">
        <h1 for="" align="center" class="font">รายชื่อข้อมูลของนักศึกษาที่ทำการสอบ Proposal ผ่าน</h1><br>
        <!-- <div class="row">
            <div class="col-md-12">
