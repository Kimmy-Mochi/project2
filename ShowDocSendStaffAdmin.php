...
<?php
        ...
        if($con->connect()){
            ...
            WHERE AuserProID = '$id' ORDER BY AuserProID ASC LIMIT $start,$row1 ";
...
<html lang="en">
    ...
    <body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
        ...
        <div id="services" class="container-fluid text-center">
            ...
            <!-- search -->
            <div class="container">
                <h2 style="color: #1f3c88;">ข้อมูลเอกสารของผู้ดูแลระบบหรือเจ้าหน้าที่</h2><br>
            ...
            <div class="container">
                ...
                <div class="row justify-content-end">
                        ...
                        <tbody align="left">
                            <tr>
                              ...
                              $i = 1;
                                    ...
                                    . "<td>".$row['uploadDatetime']."</td><td><a href=documentAdminStaff/".$row['fileName'].">".$row['fileName']."</a></td>"
                                    ."<td>".$row['SumuserProID']."</td></tr>";
                                    }
                            ?>
                            </tr>
                        </tbody>
                    ...
                    <ul class="pagination">
                        ...
                        <a class="page-link" href="showDocSendAdminStaff.php?page=<?=$page-1?>">Previous</a>
                        </li>

                        <?php for($i=1;$i<=$total_page;$i++) {?>
                        <li <?php if($page == 1) echo 'class="action"';?>>
                        <a class="page-link" href="showDocSendAdminStaff.php?page=<?=$i?>"><?=$i ?></a></li>
                        
                        <?php } ?>

                        <li <?php if($page==$total_page ) echo 'class=""';?>>
                        <a class="page-link" href="showDocSendAdminStaff.php?page=<?=$page+1?>">Next</a></li>
                    </ul>
                    </nav><br>
                    <!-- <div class="row">
