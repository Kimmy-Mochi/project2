    ...
    <span class="sr-only">Next</span>
        ...
        <h2>จัดการข้อมูลเอกสาร</h2>
            ...
            <div class="row">
                ...
                <div class="col-sm-3" align="center">
                    ...
                    <a href="teacherAddDoc.php"><img src="img/google-docs.png" width="100px" height="100px"></a>
                    <h4>เอกสารที่เกี่ยวข้องกับวิทยานิพนธ์</h4>
                </div>
                <div class="col-sm-2" align="center">
                    <!-- <span class="glyphicon glyphicon-heart logo-small"></span> -->
                    <a href="showDocTeacher.php"><img src="img/google-sheets.png" width="100" height="100"></a>
                    <h4>ตรวจสอบเอกสาร</h4>
                </div>
                <div class="col-sm-3" align="center">
                    <!-- <span class="glyphicon glyphicon-lock logo-small"></span> -->
                    <a href="manageStudentDoc.php"><img src="img/google-forms (1).png" width="100" height="100"></a>
                    <h4>เอกสารที่เกี่ยวข้องกับวิทยานิพนธ์ของนักศึกษา</h4>
                </div>
        ...
        <h2>รายละเอียดการประชุม</h2>
            ...
            <div class="row slideanim">
                ...
                <div class="col-sm-4">
                    <!-- <span class="glyphicon glyphicon-heart logo-small"></span> -->
                    <a href="./meetingAndAppeal/meettingapproveT.php?id=<?php echo $_SESSION['userProID']; ?>"><img src="img/conversation.png" width="100" height="100"></a>
        ...
        <h2>การร้องเรียน</h2>
            ...
            <div class="row slideanim">
                ...
                <div class="col-sm-4">
                    <a href="./meetingAndAppeal/Hteachersappeal.php?id=<?php echo $_SESSION['userProID']; ?>"><img src="img/teacher (1).png" width="100px" height="100px">
                    <h4>การร้องเรียนของนิสิตและอาจารย์</h4>
                </div>
        
                <div class="col-sm-4" align="center">
                    <!-- <span class="glyphicon glyphicon-lock logo-small"></span> -->
                    <a href="./meetingAndAppeal/HteachersappealS.php"><img src="img/studentt.png" width="100" height="100">
                    <h4>ร้องเรียนนักศึกษาในที่ปรึกษา</h4>
                </div>
            </div>
        </div>
        <div class="container-fluid text-center">
        ...
        <div id="data" class="container-fluid text-center">
            ...
            <div class="row slideanim">
                ...
                <div class="col-sm-4">
                    <!-- <span class="glyphicon glyphicon-heart logo-small"></span> -->
                    <a href="manageStudentForTeacher.php"><img src="img/studentt.png" width="100" height="100"></a>
