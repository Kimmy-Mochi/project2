...
<?php
        ...
        if($con->connect()){
            ...
            $total_data = "SELECT COUNT(userProID) from userprofile";
...
<html lang="en">
    ...
    <body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
        ...
        <div id="services" class="container-fluid text-center">
            ...
            <!-- search -->
            <div class="container">
                <h2 style="color: #1f3c88;">รายชื่อนักศึกษา</h2><br>
            ...
            <div class="container">
                ...
                <div class="row justify-content-end">
                        ...
                        <tbody align="left">
                            <tr>
                                ...
                                while($row= mysqli_fetch_array($objquerry)) {
                                    ...
                                    echo"<tr><td>".$i++."</td><td><a href=ShowDocSendStudentAdmin.php?id=".$row['userProID'].">".$row['userProID']."</td>"
                    ...
                    <ul class="pagination">
                        ...
                        <a class="page-link" href="manageStudentDocAdmin.php?page=<?=$page-1?>">Previous</a>
                        </li>

                        <?php for($i=1;$i<=$total_page;$i++) {?>
                        <li <?php if($page == 1) echo 'class="action"';?>>
                        <a class="page-link" href="manageStudentDocAdmin.php?page=<?=$i?>"><?=$i ?></a></li>
                        
                        <?php } ?>

                        <li <?php if($page==$total_page ) echo 'class=""';?>>
                        <a class="page-link" href="manageStudentDocAdmin.php?page=<?=$page+1?>">Next</a></li>
                    </ul>
                    </nav><br>
                    <!-- <div class="row">
