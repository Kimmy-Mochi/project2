...
$ssid = $_REQUEST['id'];
 ...
 {  
      ...
      $content = '';  
      $content .= '  
      <h1 align="center">รายงานสรุปผลการพบปะกันระหว่างนักศึกษาและอาจารย์ที่ปรึกษา</h1><br />
      <hr noshade width=50% color=black><br><br><br> 
      <table>
            <tr>  
                <th width="15%" align=left><b>รหัสนักศึกษา :</b></th>
                <th>'.$row["MuserProID"]. '</th> 
                <th width="7%" align=left><b>ชื่อ : </b></th> 
      ...
      <table border="1" cellspacing="0" cellpadding="5" >  
            ...
            <tr>
                ...
                <th width="15%" align="center"><b>วันที่พบปะ</b></th> 
                <th width="15%" align="center"><b>เวลาเริ่ม</b></th> 
                <th width="15%" align="center"><b>เวลาสิ้นสุด</b></th> 
                <th width="16%" align="center"><b>วิธีการพบปะ</b></th> 
                <th width="30%" align="center"><b>รายละเอียด</b></th> 
            </tr>
      ';  
      $content .= data();  
      $content .= '</table>';  
...
<div class="profile-images-card1">
    ...
    <div class="container">
        <h1 for="" align="center" class="font">รายงานสรุปผลการพบปะกันระหว่างนักศึกษาและอาจารย์ที่ปรึกษา</h1><br>
    </div>
