        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <!-- <img src="img/logos.png" alt="" class="image" width="120px" height="120px"> -->
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav navbar-right ">
                        ...
                        <li>
                            <a href="#data">จัดการข้อมูลผู้ใช้ระบบ</a>
                        </li>
                        <li>
                            <a href="#contact">ติดต่อ</a>
                        </li>
                        <li>
                            <a href="Notification.php">กำหนดการแจ้งเตือน</a>
                        </li>
                        <li>
                        <?php
...
<div class="container-fluid">
        ...
        <div id="document" class="container-fluid text-center " background="img/bg1.jpg">
        <h2>จัดการข้อมูลเอกสาร</h2>
            ...
            <div class="row">
                ...
                <div class="col-md-3" align="center">
                    ...
                    <a href="adminstaffAddDoc.php"><img src="img/google-docs.png" width="100px" height="100px"></a>
                    <h4>เอกสารที่เกี่ยวข้องกับวิทยานิพนธ์</h4>
                </div>
                <div class="col-md-2" align="center">
                    <!-- <span class="glyphicon glyphicon-heart logo-small"></span> -->
                    <a href="adminManageDocType.php"><img src="img/google-sheets.png" width="100" height="100"></a>
                    <h4>ประเภทเอกสาร</h4>
                </div>
                <div class="col-md-3" align="center">
                    <!-- <span class="glyphicon glyphicon-lock logo-small"></span> -->
                    <a href="manageReport.php"><img src="img/google-forms (1).png" width="100" height="100"></a>
                    <h4>เอกสารรายงาน</h4>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-3" align="center">
                        <!-- <span class="glyphicon glyphicon-off logo-small"></span> -->
                    <a href="manageStudentDocAdmin.php"><img src="img/document-512 (1).png" width="100px" height="100px"></a>
                    <h4>ข้อมูลเอกสารของนักศึกษา</h4>
                </div>
                <div class="col-md-2" align="center">
                    <!-- <span class="glyphicon glyphicon-heart logo-small"></span> -->
                    <a href="manageTeacherDocAdmin.php"><img src="img/document-512.png" width="100" height="100"></a>
                    <h4>ข้อมูลเอกสารของอาจารย์</h4>
                </div>
                <div class="col-md-3" align="center">
                    <!-- <span class="glyphicon glyphicon-lock logo-small"></span> -->
                    <a href="manageStaffDocAdmin.php"><img src="img/document-512 (2).png" width="100" height="100"></a>
                    <h4>ข้อมูลเอกสารของเจ้าหน้าที่</h4>
                </div>
            </div>
        ...
        <h2>รายละเอียดการประชุม</h2>
            ...
            <div class="row slideanim">
                ...
                <div class="col-sm-4">
                    <!-- <span class="glyphicon glyphicon-heart logo-small"></span> -->
                    <a href="./meetingAndAppeal/meettingapproveA.php"><img src="img/conversation.png" width="100" height="100"></a>
        ...
        <h2>การร้องเรียน</h2>
            ...
            <div class="row slideanim">
                ...
                <div class="col-sm-3">
                    <!-- <span class="glyphicon glyphicon-heart logo-small"></span> -->
                    <a href="./meetingAndAppeal/HadminStaffappeal.php"><img src="img/studentt.png" width="100" height="100"></a>
                    <h4>ร้องเรียนของนักศึกษา</h4>
                </div>
                <div class="col-sm-3">
                    <!-- <span class="glyphicon glyphicon-heart logo-small"></span> -->
                    <a href="./meetingAndAppeal/HadminStaffappeal1.php"><img src="img/teacher (1).png" width="100" height="100"></a>
                    <h4>ร้องเรียนของอาจารย์</h4>
                </div>
                <div class="col-sm-3">
        ...
        <div id="data" class="container-fluid text-center">
            <h2>จัดการข้อมูลผู้ใช้ระบบ</h2>
            <br>
            <div class="row slideanim">
                <div class="col-sm-2">
                ...
                <div class="col-sm-2" align="center">
                    <!-- <span class="glyphicon glyphicon-off logo-small"></span> -->
                    <a href="manageStudents.php"><img src="img/studentt.png" width="100px" height="100px">
                    <h4>STUDENTS</h4>
                </div>
                <div class="col-sm-2"  align="center">
                    <!-- <span class="glyphicon glyphicon-heart logo-small"></span> -->
                    <a href="manageTeachers.php"><img src="img/teacher (1).png" width="100" height="100">
                    <h4>TEACHERS</h4>
                </div>
                <div class="col-sm-2" align="center">
                    <!-- <span class="glyphicon glyphicon-lock logo-small"></span> -->
                    <a href="manageAdminStaff.php"><img src="img/adminn.png" width="100" height="100">
                    <h4>ADMIN OR STAFF</h4>
                </div>
                <div class="col-sm-2"  align="center">
                    <!-- <span class="glyphicon glyphicon-heart logo-small"></span> -->
                    <a href="AdvisoryAccept.php"><img src="img/consulting.png" width="100" height="100">
                    <h4>ADVISORY</h4>
                </div>
            </div>
...
<footer class="text-center text-lg-start bg-light text-muted" style="background-color: rgba(0, 0, 0, 0.05);" id="contact">
  ...
  <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05);">
    © 2021 Copyright: Thesis Supervision Control System
