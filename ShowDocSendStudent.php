...
<?php
        ...
        if($con->connect()){
            ...
            $sql= "SELECT * from document INNER JOIN documenttype on document.typeID = documenttype.categoryID WHERE SumuserProID = $id ORDER BY SumuserProID ASC LIMIT $start,$row1";
            ...
            <div class="container">
                ...
                <div class="row justify-content-end">
                    ...
                    <ul class="pagination">
                        ...
                        <a class="page-link" href="ShowDocSendStudent.php?page=<?=$page-1?>">Previous</a>
                        </li>

                        <?php for($i=1;$i<=$total_page;$i++) {?>
                        <li <?php if($page == 1) echo 'class="action"';?>>
                        <a class="page-link" href="ShowDocSendStudent.php?page=<?=$i?>"><?=$i ?></a></li>
                        
                        <?php } ?>

                        <li <?php if($page==$total_page ) echo 'class=""';?>>
                        <a class="page-link" href="ShowDocSendStudent.php?page=<?=$page+1?>">Next</a></li>
                    </ul>
                    </nav><br>
            </div>
        </div>
