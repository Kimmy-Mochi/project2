...
<?php
        ...
        if($con->connect()){
            ...
            $start = ($page-1)* $row1;
            $sql= "SELECT * from document INNER JOIN documenttype on document.typeID = documenttype.categoryID WHERE SumuserProID = $id LIMIT $start,$row1";
...
<html lang="en">
    ...
    <body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
        ...
        <div id="services" class="container-fluid text-center">
            ...
            <!-- search -->
            <div class="container">
                <h2 style="color: #1f3c88;">ข้อมูลเอกสารของนักศึกษา</h2><br>
            ...
            <div class="container">
                ...
                <div class="row justify-content-end">
                    ...
                    <ul class="pagination">
                        ...
                        <a class="page-link" href="ShowDocSendStudentAdmin.php?page=<?=$page-1?>">Previous</a>
                        </li>

                        <?php for($i=1;$i<=$total_page;$i++) {?>
                        <li <?php if($page == 1) echo 'class="action"';?>>
                        <a class="page-link" href="ShowDocSendStudentAdmin.php?page=<?=$i?>"><?=$i ?></a></li>
                        
                        <?php } ?>

                        <li <?php if($page==$total_page ) echo 'class=""';?>>
                        <a class="page-link" href="ShowDocSendStudentAdmin.php?page=<?=$page+1?>">Next</a></li>
                    </ul>
                    </nav><br>
                    <!-- <div class="row">
        ...
        for (i = 0; i < tr.length; i++) {
            td = tr[i].getElementsByTagName("td");
                if(td.length > 0){ // to avoid th
                    ...
                    || td[4].innerText.toUpperCase().indexOf(filter) > -1) {
                        tr[i].style.display = "";
                    } else {
