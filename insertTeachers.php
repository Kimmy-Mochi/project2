...
<html lang="en">
    ...
    <body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
        ...
        <form action="checkEventTeachers.php" method="POST" enctype="multipart/form-data">
            <div class="container">
                    <div class="col-12" align="left">
                        <div>
                            <h2 style="color: #1f3c88;">เพิ่มข้อมูลอาจารย์</h2>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-4 col-lg-3" >
                    <div class="form-group">
                        ...
                        <?php
                        echo "<input type='text' id='teacherID' class='form-control' size='40px' name='teacherID' autocomplete='off'>";
                ...
                <div class="col-sm-12 col-md-4 col-lg-3" >
                    <div class="form-group">
                        ...
                        <?php
                        echo "<input type='text' id='username' class='form-control' size='40px' name='username' autocomplete='off'>";
                        echo " <font size='3'><span id='message_username'></span></font>";
                        ?>
                    </div>
                </div>
                <div class="col-sm-12 col-md-4 col-lg-3" >
             ...
             <div class="row">
                <div class="col-sm-12 col-md-4 col-lg-3" >
                    ...
                    <label for="">กลุ่มวิจัยที่สังกัด
						...
						?>
                        <select name="researchgroup" id="researchgroup" style="width: 100%;height:34px;text-align: left;" class="form-control">
                ...
                <div class="col-sm-12 col-md-4 col-lg-3">
                    ...
                    <label for="usr">วุฒิการศึกษา
                        ...
                        <?php
                        echo "<input type='text' id='exampleForm2' class='form-control' size='40px' name='highestDegree' value='' placeholder='เช่น ปริญญาโท ปริญาเอก'>";
                        ?>
                    </div>
                </div>
                <div class="col-sm-12 col-md-4 col-lg-3">
                    ...
                    <label for="usr">การศึกษาล่าสุด
                        ...
                        <?php
                        echo "<input type='text' id='exampleForm2' class='form-control' size='40px' name='highestDegreeDetails' value='' placeholder='เช่น ปรด.วิทยาการคอมพิวเตอร์'>";
                        ?>
                ...
                <div class="col-sm-12 col-md-4 col-lg-3">
                    ...
                    <label for="">ตำแหน่งวิชาการ
                            ...
                            $sql = "SELECT acaposID,acaposNameTH FROM academicposition";
                            $result = mysqli_query($acaposition->connect(), $sql);
                            ?>
                            <select name="acaposition" id="acaposition" style="width: 100%;height:34px;text-align: left;" class="form-control">
                                <option id="acaposition" name="acaposition" value="" style="font-size: 16px;">- please select -</option>
                                <?php while ($row = $result->fetch_row()) { ?>
                                    <option value="<?php echo ($row[0]); ?>"><?php echo ($row[1]); ?></option>
                                <?php } ?>
                            </select>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-4 col-lg-3" >
                    <div class="form-group">
                        ...
                        <?php
                        echo "<input type='text' id='exampleForm2' class='form-control' size='40px' name='lineID' autocomplete='off'>";
                ...
                <div class="col-sm-12 col-md-4 col-lg-3">
                    <div class="form-group">
                        ...
                        <?php
                        echo "<input type='text' id='exampleForm2' class='form-control' size='40px' name='email' onSubmit='checkmail()' autocomplete='off'>";
                ...
                <div class="col-sm-12 col-md-4 col-lg-3" >
                    <div class="form-group">
                        ...
                        <?php
                        echo "<input type='text' id='exampleForm2' class='form-control' size='40px' name='tel' OnKeyPress='return chkNumber(this)' autocomplete='off'>";
