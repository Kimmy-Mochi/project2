...
<?php
        ...
        if($con->connect()){
            ...
            inner join userprofile on userprofile.userProID= document.SumuserProID WHERE SumuserProID AND typeID='1' ORDER BY SumuserProID LIMIT $start,$row1 ";
...
<html lang="en">
    ...
    <body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
        ...
        <div id="" class="container-fluid text-center">
            ...
            <!-- search -->
            <div class="container">
                <h2 style="color: #1f3c88;">รายชื่อนักศึกษาที่ส่งใบเสนอการแต่งตั้งที่ปรึกษา TS1</h2><br>
                <!-- <form action="searchTeachers.php" class="search search-form " method="GET">
                    <input type="search" placeholder="search" class="search-input" name="search">
                    <a href="searchTeachers.php">
            ...
            <div class="container">
                ...
                <div class="row justify-content-end">
                    ...
                    <table class="table table-striped" id="myTable" align="center">
                        <thead>
                            <tr style="font-size: 18px;">
                                ...
                                <th>นามสกุล</th>
                                <th>ไฟล์ TS1</th>
                                <th>เพิ่มข้อมูลการอนุมัติ</th>
                                <th>แสดงข้อมูลการอนุมัติ</th>
                            </tr>
                        </thead>
                        <tbody align="left">
                            <tr>
                                ...
                                while($row= mysqli_fetch_array($objquerry)) {
                                    ...
                                    echo"<tr><td>".$i++."</td><td>".$row['userProID']."</td>"
                                    ."<td>".$row['firstNameTH']."</td><td>".$row['lastNameTH']."</td><td><a href=documentStudents/".$row['fileName'].">".$row['fileName']."</a></td>
                                    <td><a href=manageAdvisory.php?id=".$row['userProID']." class='btn btn-warning a-btn-slide-text'>
                                        <span class='glyphicon glyphicon-plus' aria-hidden='true'></span>
                                        <span><strong>เพิ่มข้อมูล</strong></span></a></td><td><a href=showAdvisory.php?id=".$row['userProID']." class='btn btn-success a-btn-slide-text'>
                                        <span class='' aria-hidden='true'></span>
                                        <span><strong>แสดงข้อมูล</strong></span></a></td></tr>";
                                }
                        ?>
                            </tr>
                        </tbody>
                    ...
                    <ul class="pagination">
                        ...
                        <a class="page-link" href="AdvisoryAccept.php?page=<?=$page-1?>">Previous</a>
                        </li>

                        <?php for($i=1;$i<=$total_page;$i++) {?>
                        <li <?php if($page == 1) echo 'class="action"';?>>
                        <a class="page-link" href="AdvisoryAccept.php?page=<?=$i?>"><?=$i ?></a></li>
                        
                        <?php } ?>

                        <li <?php if($page==$total_page ) echo 'class=""';?>>
                        <a class="page-link" href="AdvisoryAccept.php?page=<?=$page+1?>">Next</a></li>
                    </ul>
                    </nav><br>
                    <!-- <div class="row">
