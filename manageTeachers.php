...
<?php
        ...
        if($con->connect()){
            ...
            $total_data = "SELECT COUNT(userProID) from userprofile where status = 'T'";
            ...
            $sql="SELECT * from userprofile where status = 'T' ORDER BY userProID LIMIT $start,$row1";
...
<html lang="en">
    ...
    <body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
        ...
        <div class="profile-images-card1">
            <!-- search -->
            <div class="container">
                <h2 style="color: #1f3c88;">จัดการข้อมูลอาจารย์</h2><br>
            ...
            while($row= mysqli_fetch_array($objquerry)) {
                ...
                . "<td><a href=editTeachers.php?id=".$row['userProID']." class='btn btn-warning a-btn-slide-text'>
                <span class='glyphicon glyphicon-edit' aria-hidden='true'></span>
                <span><strong>Edit</strong></span></a><td><a href=ShowDataTeacher.php?id=".$row['userProID'].">".$row['username']."</td>"
      ...
      ?>
                    ...
                    <ul class="pagination">
                        ...
                        <a class="page-link" href="manageTeachers.php?page=<?=$page-1?>">Previous</a>
                        </li>

                        <?php for($i=1;$i<=$total_page;$i++) {?>
                        <li <?php if($page == 1) echo 'class="action"';?>>
                        <a class="page-link" href="manageTeachers.php?page=<?=$i?>"><?=$i ?></a></li>
                        
                        <?php } ?>

                        <li <?php if($page==$total_page ) echo 'class=""';?>>
                        <a class="page-link" href="manageTeachers.php?page=<?=$page+1?>">Next</a></li>
                    </ul>
                    </nav><br>
                    <div class="row">
