...
$datetime=date("Y-m-d H:i:s");
        ...
        if (isset($_POST["submit"])) {
           // echo "55555";
            ...
            $sql = "INSERT INTO document(SumuserProID,TuserProID,typeID,details,uploadDatetime,fileName) VALUES ('$sID','$userID','$doctype', '$details','$datetime','$file_name')";
           // $sql = "INSERT INTO `document`(`fileName`) VALUES ('$file_name')"; 
            ...
            if (move_uploaded_file($file_tmp, $file_target)) { 
                ...
                if(mysqli_query($link->connect(), $sql)){
                    echo "<script>window.alert('บันทึกข้อมูลสำเร็จ')</script>";
                	echo "<script>window.location='teacherAddDoc.php'</script>";
...
//mysqli_close($link);
    ...
    if($result) {
        ...
        echo "<script>window.location='showDocTeacher.php'</script>";
        // header ("Location:showDocTeacher.php");
    }
    else {
